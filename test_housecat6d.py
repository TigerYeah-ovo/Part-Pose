...
def init():
    ...
    cfg.log_dir = os.path.join('/data/yecl24/ExperimentalResults/6dpe/part_registration/log', exp_name)
...
if __name__ == "__main__":
    ...
    checkpoint_dir = os.path.join(cfg.ckpt_dir, 'epoch_' + str(cfg.test_epoch) + '.pt')
    checkpoint = torch.load(checkpoint_dir)
    logger.info("=> loading checkpoint from: {} ...".format(checkpoint_dir))
